...
//     const x = Math.floor(Math.random() * (window.innerWidth - width - SQUARE_PADDING * 2));
//     const y = Math.floor(Math.random() * (window.innerHeight - height - SQUARE_PADDING * 2));
...
//           ? { ...item, x: e.clientX - offset.current.x, y: e.clientY - offset.current.y }
//           : item
//       )
//     );
//   };
...
//       style={{ width: "100vw", height: "100vh", position: "relative", backgroundColor: "#222" }}
//     >
//       {items.map(item => (
